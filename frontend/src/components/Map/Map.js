...
function Map() {
  ...
  useEffect(() => {
    ...
    map.on('load',  () =>  {
      ...
      const circleRadius = addMbTiles.getCircleRadius()
      ////////////////// Red points //////////////////////////////////////
      map.addSource("CAT_S1_UD_A132D110_201601_201912_EPSG_4326_WGS_84", {
        "type": "vector",
        /* "tiles": ["http://seinterferdev01:8080/data/CAT_S1_UD_A132D110_201601_201912_EPSG_4326_WGS_84-f-pf-pk/{z}/{x}/{y}.pbf"], */
        "url": "http://seinterferdev01:8080/data/CAT_S1_UD_A132D110_201601_201912_EPSG_4326_WGS_84-f-pf-pk.json",
        "minzoom": 0,
        "maxzoom": 14
      });
      map.addLayer({
        "id": "CAT_S1_UD_A132D110_201601_201912_EPSG_4326_WGS_84",
    ...
    map.on('load', function () {
      ...
      map.addSource("CAT_S1_UD_A132D037_201601_201912_EPSG_4326_WGS_84", {
        "type": "vector",
        /* "tiles": ["http://seinterferdev01:8080/data/CAT_S1_UD_A132D037_201601_201912_EPSG_4326_WGS_84-f-pf-pk/{z}/{x}/{y}.pbf"], */
