...
map.on('load', function() {
    ...
    map.addSource("MINA_CAPELA_S1_EW_A078D041_201907_202101", {
        "type": "vector",
        "url": "http://localhost:8081/data/MINA_CAPELA_S1_EW_A078D041_201907_202101-f-pf-pk.json", 
        "minzoom": 0,
        "maxzoom": 14 
    });       
    map.addLayer({
    ...
    map.addSource("MINA_CAPELA_S1_UD_A078D041_201907_202101", {
        "type": "vector",
        "url": "http://localhost:8081/data/MINA_CAPELA_S1_UD_A078D041_201907_202101-f-pf-pk.json", 
        "minzoom": 0,
        "maxzoom": 14 
    });       
    map.addLayer({
    ...
    map.addSource("BUCHAREST_S1_LOS_D109_201701_202012", {
        "type": "vector",
        "url": "http://localhost:8081/data/BUCHAREST_S1_LOS_D109_201701_202012-f-pf-pk.json", 
        "minzoom": 0,
        "maxzoom": 14 
    });       
    map.addLayer({
